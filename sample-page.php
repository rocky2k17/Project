...
<body id="body">
    ...
    <div class="holder-fluid" style="background: #f1f1f1;text-align: center;padding: 30px 0;box-shadow: inset 0px 0px 20px -2px #c4d0d9;">
        <div class="holder">
            ...
            <div class="breadcumb">
                <a href="index.php">Home</a>
                <a href="Project2/index.php">sample page</a>
            </div>
        </div>
    </div>
    <div class="holder gswa-sample-page">
        ...
        <div class="grid-12">
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum labore illo impedit unde sequi! Totam ipsam delectus atque voluptate similique dolore, maiores, molestias voluptatibus doloremque quam alias enim beatae officia!</p>
        </div>
    </div>
    <br>
    <br>
